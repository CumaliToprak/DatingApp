...
namespace DatingApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase //A base class for an MVC controller without view, we use angular for view implementation
    {
        ...
        public AuthController(IAuthRepository repo, IConfiguration config, IMapper mapper)// Burdaki parametreyi daha önce AuthRepository yaptığımdan çalışmamıştı. Dikkat!
        {
            _config = config;
            _repo = repo;
            _mapper = mapper;
